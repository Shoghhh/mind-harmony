...
export const icons: Record<string, (props?: IconProps) => React.ReactNode> = {
    ...
    keyArrowRight: () => <MaterialIcons name="keyboard-arrow-right" size={34} color={colors.secondary} />,
    keyArrowLeft: () => <MaterialIcons name="keyboard-arrow-left" size={34} color={colors.secondary} />,
